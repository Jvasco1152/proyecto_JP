...
export default function StepReview({
  ...
  return (
    <div className="space-y-4">
      <div>
        <h2 className="text-lg font-bold text-slate-900">Revisión y Generación</h2>
        <p className="text-sm text-slate-500 mt-0.5">Resumen de la inspección y generación del informe</p>
      </div>
      ...
      <div className="bg-white rounded-xl border border-slate-200 p-4">
        <div className="flex items-center gap-2 mb-3">
          ...
          <span className="text-sm font-bold text-slate-800">Datos de la inspección</span>
        </div>
      ...
      <div className="bg-gradient-to-br from-primary-50 to-indigo-50 rounded-xl border border-primary-200 p-4">
        <div className="flex items-center gap-2 mb-3">
          ...
          <span className="text-sm font-bold text-primary-900">Análisis con IA</span>
        </div>

        {!analysis && !aiLoading && !aiError && (
          <div className="text-center py-4">
            <p className="text-sm text-slate-600 mb-3">
              Genera un análisis inteligente de los resultados de la inspección
            </p>
        ...
        {aiLoading && (
          <div className="flex flex-col items-center py-6 gap-3">
            ...
            <p className="text-sm text-primary-700">Analizando inspección...</p>
          </div>
        )}
        ...
        {analysis && (
          <div className="space-y-3">
            ...
            {analysis.hallazgosCriticos.length > 0 && (
              <div className="bg-white rounded-lg p-3">
                <p className="text-xs font-medium text-slate-500 mb-2">Hallazgos Críticos</p>
